...
{
    class BehaviorAttack : BehaviorAbstract
    {
        public override void action(Monster parent)
        {
            ...
            attackMessage[0] = "HYPER SUPER MEGA ULTRA OMEGA ATTACK!";
            ...
            parent.Attack(BehaviorRSTS.acquireTarget(), Globals.ELEMENT_PHYSICAL, "cowabunga", 12);
        }
    }
}
